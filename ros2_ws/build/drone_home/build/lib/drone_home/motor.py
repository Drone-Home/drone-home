...
class MotorController:
    # Constants
    SERVO_MIN = -20 #bounds for forwrds reverse
    SERVO_MAX = 20
    SERVO_TRIM = 0.0

    def __init__(self, pin=13, min_angle=-90, max_angle=90, frame_width=0.0023):
        # Initialize the servo on pin 13 for driving
