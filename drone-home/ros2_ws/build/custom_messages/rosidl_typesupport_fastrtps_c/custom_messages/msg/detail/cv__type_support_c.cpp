...
#include "custom_messages/msg/detail/cv__rosidl_typesupport_fastrtps_c.h"
...
using _CV__ros_msg_type = custom_messages__msg__CV;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CV__ros_msg_type * ros_message = static_cast<const _CV__ros_msg_type *>(untyped_ros_message);
  // Field name: x_pos
  {
  ...
  void * untyped_ros_message)
{
  ...
  _CV__ros_msg_type * ros_message = static_cast<_CV__ros_msg_type *>(untyped_ros_message);
  // Field name: x_pos
  {
    cdr >> ros_message->x_pos;
  }
...
static uint32_t _CV__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_messages__msg__CV(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_messages__msg__CV;
    is_plain =
      (
...
static size_t _CV__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_messages__msg__CV(
...
static message_type_support_callbacks_t __callbacks_CV = {
  "custom_messages::msg",
  "CV",
  _CV__cdr_serialize,
...
static rosidl_message_type_support_t _CV__type_support = {
