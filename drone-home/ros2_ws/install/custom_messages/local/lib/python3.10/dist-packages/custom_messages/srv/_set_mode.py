...
class Metaclass_SetMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from custom_messages.srv import _set_mode
...
class SetMode(metaclass=Metaclass_SetMode):
    from custom_messages.srv._set_mode import SetMode_Request as Request
    from custom_messages.srv._set_mode import SetMode_Response as Response
