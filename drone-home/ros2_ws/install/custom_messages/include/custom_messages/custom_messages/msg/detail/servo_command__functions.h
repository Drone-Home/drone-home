...
#ifndef CUSTOM_MESSAGES__MSG__DETAIL__SERVO_COMMAND__FUNCTIONS_H_
#define CUSTOM_MESSAGES__MSG__DETAIL__SERVO_COMMAND__FUNCTIONS_H_
 ...
 * calls
 * custom_messages__msg__ServoCommand__init().
...
/**
 * It calls
 * custom_messages__msg__ServoCommand__fini()
 ...
 * custom_messages__msg__ServoCommand__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * custom_messages__msg__ServoCommand__Sequence__fini()
 * on the array,
...
#endif  // CUSTOM_MESSAGES__MSG__DETAIL__SERVO_COMMAND__FUNCTIONS_H_
