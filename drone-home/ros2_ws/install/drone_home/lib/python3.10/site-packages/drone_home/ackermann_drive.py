...
class DriveSubscriber(Node):
    ...
    def timer_callback(self):
        ...
        pwm_drive_active = not NO_CONTROLLER_MODE and (drive_power_pwm > .25 or drive_power_pwm < -.25)
        pwm_steering_active = not NO_CONTROLLER_MODE and (steering_angle_pwm > radians(4.1) or steering_angle_pwm < radians(-4.1))
        ...
        cv_drive_active = True # disable GPS drive
